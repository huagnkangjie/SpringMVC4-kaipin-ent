package com.kaipin.task.common.page;
...
public class GenericDefaultPage<T> implements IGenericPage<T> {
	 ...
	 *            数据总个数
	 */
	public GenericDefaultPage(int pageNo, int pageSize, List<T> elements, int totalCount) {
	 ...
	 * @see #emptyPage()
	 */
	public static final GenericDefaultPage EMPTY_PAGE = new GenericDefaultPage(0, 0, Collections.emptyList(), 0);
