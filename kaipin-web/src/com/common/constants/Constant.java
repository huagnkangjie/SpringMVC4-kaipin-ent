...
public class Constant {
	...
	public static String USER_TYPE_ENT = "11";//企业类型
	public static String USER_TYPE_STU = "10";//学生类型
	public static String USER_TYPE_SCH = "12";//学校类型
	 ...
	 * 常量配置
	 */
	public static String PRO_FILE_CONSTANTS = "config/constants.properties";
	 ...
	 * 文件上传配置文件
	 */
	public static String PRO_FILE_PATH = "config/filePath.properties";
