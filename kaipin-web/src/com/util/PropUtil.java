...
//	private static final String PROP_FILE = "ftp.properties";
	private static final String PROP_FILE = "config/filePath.properties";
	...
	public static void main(String args[]) {
		...
		PropUtil pu2 = new PropUtil();
		System.out.println(pu.getValue("app.search.url"));
		System.out.println(pu2.getValue("ip"));
	}
}
