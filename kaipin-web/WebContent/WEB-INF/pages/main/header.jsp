...
<!-- 	<script> -->
<!--  		if (document.documentMode == 8 || document.documentMode == 7 || document.documentMode == 6 || document.documentMode == 5) -->
<!--  		{  -->
<%-- 			window.location.href="<%=path%>/loginController/downLoad.do"; --%>
<!--  		} -->
<!-- 	</script> -->
