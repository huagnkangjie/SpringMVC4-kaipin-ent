...
// 					location.href= r_path + "/loginController/index.do";
		...
		function doSave(){
			$.ajax({                
				...
				async: true, 
				type: "POST",                
				url:  '<%=path%>/certificate/certificateSch',                
				...
				complete: function(data) { 
					...
					if(datas.success){
						location.href="<%=path%>/certificate/checkPageSch?uploadAgin=regedit&userId="+userId+"&orgId="+companyId;
					}else{
						alert("上传失败，请重新上传");
						$("#save").show();
						$("#saveing").hide();
					...
					<form id="certificateForm" name="certificateForm" action="<%=path%>/certificate/certificateEnt" method="post">
						<div class="basic-informations upload-files">
							<div class="upf-areas">
								...
								<div class="load-upf">
									<a href="javascript:void(0)" class="upf-btn select-up-img-btn" data-tag="jyxkz" id="jyxkzSelect">上传许可证
										<img id="jyxkzIng" src="<%=path %>/images/loading.gif" style="display:none;"/>
									</a>
									<div class="file-prv" style="display: none;" id="jyxkzShowDiv">
										<img  src="<%=path %>/images/gx_zheng_b.jpg" id="jyxkzShow" onclick="imgbox.show(this.src)"alt="预览文件"/>
									</div>
								</div>
							</div>
							...
							<div class="exam-preview">
								<p>参考实例</p>
								<div class="file-prv">
									<img  src="<%=path %>/images/gx_zheng_b.jpg"  onclick="imgbox.show(this.src)"alt="预览文件"/>
								</div>
							</div>
						...
						<div class="basic-informations upload-files">
							<div class="upf-areas">
								<div class="upf-tlt">
									<p>上传学校招就办指定联系人身份证正面照片、工作证照片（选填）、</br>名片照片（选填）</p>
									<p>（选填项上传有助于审核速度）</p>
								</div>
								<div class="notice">
									<p>请上传清晰图片，尺寸不超过1600像素*2000像素，大小不超过2M</p>
								...
								<div class="upf-file-lists">
									...
									<div class="load-upf">
										...
										<div class="file-prv" id="gzzShowDiv" style="display:none;">
											<img  src="<%=path %>/images/gx_gongzuo_b.jpg" id="gzzShow"  onclick="imgbox.show(this.src)"alt="预览文件"/>
										</div>
									</div>
									<div class="load-upf">
										<a href="javascript:void(0)" class="upf-btn select-up-img-btn" data-tag="mp" id="xszSelect">上传名片
											<img id="mpIng" src="<%=path %>/images/loading.gif" style="display:none;"/>
										</a>
										<div class="file-prv" id="mpShowDiv" style="display:none;">
											<img  src="<%=path %>/images/gx_mingpian_b.jpg" id="mpShow"  onclick="imgbox.show(this.src)"alt="预览文件"/>
										</div>
									</div>
								</div>
							...
							<div class="exam-preview exam-preview-lists">
								...
								<div class="file-prv">
									<img  src="<%=path %>/images/gx_gongzuo_b.jpg"  onclick="imgbox.show(this.src)"alt="预览文件"/>
								</div>
								<div class="file-prv">
									<img  src="<%=path %>/images/gx_mingpian_b.jpg"  onclick="imgbox.show(this.src)"alt="预览文件"/>
								</div>
