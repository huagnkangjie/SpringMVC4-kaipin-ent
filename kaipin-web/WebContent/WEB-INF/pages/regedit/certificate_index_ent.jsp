...
<html>
	...
	<script type="text/javascript">
		...
		function certificate(){
			window.location.href= r_path + "/regedit/init?oper=certificate_ent&userId="+userId+"&orgId="+companyId;
		}
	</script>
  </head>
...
<!-- 								</li> -->
		...
		<div class="footer">
			<div class="foot">
				<ul>
<%-- 					<li><a href="<%=path%>/v/about">关于我们 </a></li> --%>
<!-- 					| -->
<%-- 					<li><a href="<%=path%>/v/help">帮助中心 </a></li> --%>
				</ul>
				<p>© 2016 开频</p>
			</div>
		</div>
