...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=path%>/js/regedit/login.js"></script> 
		<script type="text/javascript">
		...
		<div id="dowebok">
			...
			<div class="section section1">
				...
				<div class="recruit-login flipInX" id="recruit-login">
					<form id="form1" target="post_frame" name="form1" action="http://127.0.0.1:8080/kaipin-sso/web/auth/login" method="post">
						...
						<p class="login-sumit">
							<input type="button" onclick="login();" id="loginBtn" class="submit-btn"   value="登录"/>
