	...
	jQuery(function($){  
		...
		//最高学历
		$("#educationCode").blur(function (){
			flag = false;
			if(checkValLength2("educationCode")){
				educationCode(); 
			}
		});
...
//							}
	...
	//***********************数据提交  ent*******************************
		...
		function educationCode(){
			...
			var edu = $("#educationCode").val();
			var flags = false;
			debugger;
			if(edu == '' || edu == '0'){
				$("#educationCode-erro").addClass("ipt-txt-Err");
				$("#educationCodeTip").html("请选择最高学历");
				$("#educationCodeTip").show();
				flags = false;
			}else{
				$("#educationCode-erro").removeClass("ipt-txt-Err");
				$("#educationCodeTip").hide();
				flags = true;
			}
			return flags;
		}
		
		$("#educationCode").click(function(){
			var edu = $("#educationCode").val();
			if(edu == '' || edu == '0'){
				$("#educationCode-erro").addClass("ipt-txt-Err");
				$("#educationCodeTip").html("请选择最高学历");
