				...
				<div class="all-sheet register-box">
					...
					<div class="rgb-panel">
						<form id="regeditForm" name="regeditForm" action="<%=path%>/loginController/register.do" method="post">
							<div class="rgb-infos">
								<input type="text" class="input" id="userName" name="userName" placeholder="真实姓名" maxlength="10"/>
								<span class="error-info" id="userNameTip" ></span>
							</div>
							<div class="rgb-infos">
								<input type="text" class="input" id="phone" name="phone" placeholder="手机号码，忘记密码时用于找回密码" maxlength="11"/>
...
<!-- 								<input type="button" id="btn" value="免费获取验证码" onclick="settime(this)" /> -->
							...
							<div class="rgb-infos controlPassword">
								<input type="text" class="input" id="password" name="password" placeholder="输入密码" />
								<input type="text" class="input placeholder" placeholder="输入密码" />
								<span class="error-info" id="passwordTip"></span>
							</div>

							<div class="rgb-infos controlPassword">
								<input type="text" class="input" id="password2" placeholder="再输入一次密码" />
...
<!-- 								<img src="images/yanZma.jpg" class="yzmImg" width="73" height="30" alt="验证码"> -->
							...
							<div class="rgb-infos submit-btn">
								...
								<a href="javascript:void(0);" class="btn-blue sub-btn" style="display:none;" id="submit-reg">提交中...</a>
							</div>
						</form>
					</div>
					<!--提交账号信息 end-->
		...
		<!-- footer_reg start-->
		<div class="footer_reg" id="footer_reg">
			<div class="foot_rg">
				<div class="ft-infos">
					<a href="/loginController/about">关于我们</a>  
					<span class="rule">|</span>  
					<a href="/loginController/help">帮助中心</a>  <span class="rule">|</span>  意见反馈QQ群：185930548  <span class="rule">|</span>  © 2015开频校招  渝ICP备15011713号-2
				</div>
			</div>
		</div>
