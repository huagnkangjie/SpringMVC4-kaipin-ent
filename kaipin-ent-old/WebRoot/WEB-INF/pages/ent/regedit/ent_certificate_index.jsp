...
<html>
	...
	<script type="text/javascript">
		...
		function certificate(){
			window.location.href= r_path + "/regedit/certificate.do?target=certificate&userId="+userId+"&companyId="+companyId;
		}
	</script>
  </head>
...
<!-- 								</li> -->
		...
		<div class="footer">
			<div class="foot">
				<ul>
					<li><a href="<%=path%>/loginController/about">关于我们 </a></li>
<!-- 					| -->
<%-- 					<li><a href="<%=path%>/loginController/help">帮助中心 </a></li> --%>
				</ul>
				<p>Copyright © 2015 LaMi Inc. 保留所有权利    渝ICP备15011713号-2</p>
			</div>
		</div>
		<!--footer end-->
