	...
	<script type="text/javascript">
		 ...
		 $(function (){
			 datagrid =	$('#grid').datagrid({
				title : '',
				url : '<%=path%>/resume/datagridGoutList.do?status=2',
				pagination : true,
				fitColumns : true,
				showRefresh : false,
				pageSize : 20,
...
// 			 getResumeCount();
		 ...
		 function test(index){
			 ...
			 location.href="<%=path%>/resumePassOrNoController/passPage.do?postionId="+postionId;
		 }
		 
		 function detail(id){
			 location.href="<%=path%>/resumePassOrNoController/passPage.do?postionId="+id;
		 }
	</script>
