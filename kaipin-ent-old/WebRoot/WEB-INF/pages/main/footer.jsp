...
<!--  				</ul> --> 
<!-- 				<p>Copyright © 2015 LaMi Inc. 保留所有权利   &copy; 2015开频校招   渝ICP备15011713号-2</p> -->
<!-- 			</div> -->
<!-- 		</div> -->
		<!-- <div class="footer">
			<div class="foot">
				<div class="ft-infos">
					...
					<a href="<%=path%>/loginController/help">帮助中心</a>  <span class="rule">|</span>  意见反馈QQ群：185930548  &copy;  2015开频校招　渝ICP备15011713号-2
				</div>
			</div>
		</div> -->
		...
		<div class="footer">
			<div class="foot">
				<p class="ft-l">© 2015开频校招 渝ICP备15011713号-2</p>
				<p class="ft-r">
				<a href="<%=path%>/loginController/about">关于我们</a> 
<!-- 					<span class="rule">|</span> -->
<%-- 					<a href="<%=path%>/loginController/help">帮助中心</a> --%>
					<span class="rule">|</span>
