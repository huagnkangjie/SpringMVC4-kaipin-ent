...
public class FTPUtil {
	 ...
	 * @param input
	 */
	public boolean uploadImg(String fileDir, String fileType, String fileName, InputStream input) {
		try {
			ftp.makeDirectory("11");//切换到企业的账号下去
			ftp.changeWorkingDirectory("11");
...
//	            	AnnexCache.removeCacheByKey(sessionId);
	...
	public void uploadImgCut(String fileName, InputStream input, String type) {
		try {
			ftp.makeDirectory("11");//切换到图片临时文件夹
			ftp.changeWorkingDirectory("11");
