...
public class ExamManagerController {
	...
	public String addPage(HttpServletRequest request, String positionId, Model model) {
		try {
	...
	public void add(HttpServletRequest request,HttpServletResponse response, ExamListBean examList, String positionId) {
		try {
			...
			response.sendRedirect(url + "/examManager/init.do");
		} catch (Exception e) {
			e.printStackTrace();
			log.info(LogUtil.getTrace(e));;
			//return null;
	...
	public String editPage(HttpServletRequest request, String paperId, Model model, String oper) {
		try {
			HashMap<String,Object> map = new HashMap<String, Object>();
	...
	public String edit(HttpServletRequest request, ExamListBean examList, 
			String paperId, String editFlag, String dbId) {
		try {
			ExamPaper paper = paperService.selectByPrimaryKey(paperId);
	 ...
	 */
	@RequestMapping(value = "/detail")
	public String detail(HttpServletRequest request, String paperId, String uId ) {
		try {
