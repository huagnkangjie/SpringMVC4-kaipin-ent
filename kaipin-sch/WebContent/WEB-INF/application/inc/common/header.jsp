...
<html>
  <head>
	...
	<!-- 系统 -->
	<link rel="stylesheet" href="${STATIC_SCH }/css/basic.css?v.<%=System.currentTimeMillis()%>" />
	<link rel="shortcut icon" href="${BASE_PATH }/favicon.ico" type="image/x-icon" />
	<script type="text/javascript" src="${STATIC_COM }/js/jquery-1.11.1.min.js?v.<%=System.currentTimeMillis()%>" ></script>
	...
	<script type="text/javascript">
		...
		$(function (){
			...
			$("#push-position").click(function (){
				location.href="<%=path%>/company/position/pulishPage.do";
			});
			...
			<div class="operation-nav">
				<div class="nav-lists">
					<ul class="lists-details fl">
						...
						<li><a href="<%=path%>/company/position/init.do">职位库</a></li>
						<li><a href="<%=path%>/company/examCount/init.do">笔试管理</a></li>
						<li><a href="<%=path%>/test/weixin.do">测试</a></li>
					</ul>
				...
				<div class="personal-forms">
					<form method="post">
						...
						<div class="pf-otherStyle">
							<div class="pf-totalStyle">
								<span class="pf-tips">姓名</span>
								<input type="text" id="user-userName" name="userName" class="pf-input"/>
							</div>
...
<!-- 											<span class="select_txt" id="user-sex-select"></span> -->
<!-- 											<input type="text" class="hide-input hide" name="sex" id="user-sex"/> -->
<!-- 											<span class="selet_open"></span> -->
<!-- 											<div class="option userinfo" style="display: none;"> -->
<!-- 												<a href="javascript:void(0)" data-tag="2">男</a> -->
<!-- 												<a href="javascript:void(0)" data-tag="1">女</a> -->
<!-- 											</div> -->
<!-- 										</div> -->
<!-- 									</li> -->
<!-- 								</ul> -->
