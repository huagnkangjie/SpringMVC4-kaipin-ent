					...
					<form id="certificateForm" name="certificateForm" action="<%=path%>/certificate/certificateEnt" method="post">
						<div class="basic-informations upload-files">
							<div class="upf-areas">
								...
								<div class="load-upf">
									<a href="javascript:void(0)" class="upf-btn select-up-img-btn" data-tag="jyxkz" id="jyxkzSelect">上传许可证
										<img id="jyxkzIng" src="${STATIC_SCH }/images/loading.gif" style="display:none;"/>
									</a>
									<div class="file-prv" style="display: none;" id="jyxkzShowDiv">
										<img  src="${STATIC_SCH }/images/gx_zheng_b.jpg" id="jyxkzShow" onclick="imgbox.show(this.src)"alt="预览文件"/>
									</div>
								</div>
							</div>
							...
							<div class="exam-preview">
								<p>参考实例</p>
								<div class="file-prv">
									<img  src="${STATIC_SCH }/images/gx_zheng_b.jpg"  onclick="imgbox.show(this.src)"alt="预览文件"/>
								</div>
							</div>
						...
						<div class="basic-informations upload-files">
								...
								<div class="upf-file-lists">
									...
									<div class="load-upf">
										...
										<div class="file-prv" id="gzzShowDiv" style="display:none;">
											<img  src="${STATIC_SCH }/images/gx_gongzuo_b.jpg" id="gzzShow"  onclick="imgbox.show(this.src)"alt="预览文件"/>
										</div>
									</div>
									<div class="load-upf">
										...
										<div class="file-prv" id="mpShowDiv" style="display:none;">
											<img  src="${STATIC_SCH }/images/gx_mingpian_b.jpg" id="mpShow"  onclick="imgbox.show(this.src)"alt="预览文件"/>
										</div>
									</div>
								</div>
							...
							<div class="exam-preview exam-preview-lists">
								...
								<div class="file-prv">
									<img  src="${STATIC_SCH }/images/gx_gongzuo_b.jpg"  onclick="imgbox.show(this.src)"alt="预览文件"/>
								</div>
								<div class="file-prv">
									<img  src="${STATIC_SCH }/images/gx_mingpian_b.jpg"  onclick="imgbox.show(this.src)"alt="预览文件"/>
								</div>
