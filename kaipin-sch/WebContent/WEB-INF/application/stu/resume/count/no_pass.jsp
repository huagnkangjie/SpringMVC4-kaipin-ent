	...
	<script type="text/javascript">
		 ...
		 $(function (){
			 datagrid =	$('#grid').datagrid({
				title : '',
				url : '<%=path%>/company/resume/datagridGoutList.do?status=3',
				pagination : true,
				fitColumns : true,
				showRefresh : false,
				pageSize : 20,
				...
				columns : [ [ {
					...
					formatter : function(value, rec, i){
						return "<a href='javascript:void(0)' onclick='detail(" + i + ");' class='table-opreat-btn see-btn'>查看</a>";
					}
				} ] ],
				toolbar : '#toolbar',
...
// 			 getResumeCount();
		 ...
		 function detail(index){
			 ...
			 var id = row.postion_id;
			 location.href="<%=path%>/company/resumePassOrNo/noPassPage.do?postionId="+id;
		 }
	</script>
