	...
	<script type="text/javascript">
		 ...
		 $(function (){
			 datagrid =	$('#grid').datagrid({
				title : '',
				url : '<%=path%>/company/resume/datagridGoutList.do?status=2',
				pagination : true,
				fitColumns : true,
				showRefresh : false,
				pageSize : 20,
...
// 			 getResumeCount();
		 ...
		 function test(index){
			 ...
			 location.href="<%=path%>/company/resumePassOrNo/passPage.do?postionId="+postionId;
		 }
		 
		 function detail(id){
			 location.href="<%=path%>/company/resumePassOrNo/passPage.do?postionId="+id;
		 }
	</script>
