	...
	<script type="text/javascript">
		 ...
		 $(function (){
			 ...
			 datagrid =	$('#grid').datagrid({
				...
				columns : [ [ {
					...
					resizable : false,
					formatter:function(value,row,i){
						return  "<a href='javascript:void(0);' onclick='passOrNo(3,"+i+")' class='btn-set color-fail'>不通过</a>" +
								"<a href='javascript:void(0);' onclick='passOrNo(2,"+i+")' class='btn-set color-pass'>通过</a>" + 
				...
				onLoadSuccess : function(data) {
					...
					if(length == 0){
						$("#sum").append("<a href='javascript:void(0)'><span>0</span></a>");
					}else{
		 ...
		 */
		 function detail(index){
			 ...
			 location.href="<%=path%>/company/resume/detail?status="+status+"&resumeId="+resumeId+"&relationId="+relationId+"&userId="+userId+"&postionId="+postionId;
		 }
