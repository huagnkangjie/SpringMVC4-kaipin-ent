...
<%-- 	<link href="${STATIC_ENT }/css/dialog.css" rel="stylesheet" type="text/css"> --%>
	...
	<script type="text/javascript">
		...
		function back(){
			//window.history.back();
			 location.href=r_path+"/company/position";
		}
	</script>
	<style type="text/css">
	...
	<!--发布职位中心 开始-->
		<div class="post-office-center" style="margin-top: 88px;">
			<div class="post-office">
				...
				<div class="send-offer-forms">
					<form id="form1" name="form1" method="post" action="<%=path%>/company/position/edit.do">
