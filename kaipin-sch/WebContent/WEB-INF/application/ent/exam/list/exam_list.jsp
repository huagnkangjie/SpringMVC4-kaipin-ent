	...
	<script type="text/javascript">
		 ...
		 $(function (){
			 ...
			 datagrid =	$('#grid').datagrid({
				title : '',
				url : '<%=path%>/company/examList/datagrid.do',
				queryParams:{
		 ...
		 */
		 function detail(index){
			 ...
			 if(isNotEmptys(paperId)){
				 location.href="<%=path%>/company/examList/detail.do?paperId="+paperId+"&uId="+uId+"&inviteId="+inviteId+"&userName=" + encodeURI(userName);
			 }else{
				 $.fn.fandialog({
						title:"提示信息",
						contents: "该试卷未进行作答",
