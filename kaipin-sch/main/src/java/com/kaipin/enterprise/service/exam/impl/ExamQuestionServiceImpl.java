...
import com.kaipin.enterprise.model.exam.ExamBean;
...
public class ExamQuestionServiceImpl implements IExamQuestionService{
	...
	@Autowired
	private IExamQuestionDao questionMapper;//题目表
	@Autowired
	private IExamQuestionDbDao dbMapper;//题库
	@Autowired
	private IExamPaperDao paperMapper;//试卷
	@Autowired
	private IExamDao mapper;//考试接口库
	@Autowired
	private IExamPaperPositionDao paperPositionMapper;//卷子和职位绑定表
	@Autowired
	private IPositionInfoDao positionMapper;
