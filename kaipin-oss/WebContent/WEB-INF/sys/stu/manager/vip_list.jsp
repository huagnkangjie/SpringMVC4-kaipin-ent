<%@ page language="java" contentType="text/html; charset=utf-8"
	pageEncoding="utf-8"%>
	 <link href="${BASE_PATH}/public/assets/css/basic.css" rel="stylesheet" />
...
<body>
	...
	<div class="wrap js-check-wrap">
		...
		<form class="well form-search"  name="form-search" method="post"  action="${BASE_PATH }/management/stu/main/viplist">
		...
		<form class="js-ajax-form" action="" method="post">
			...
			<div>
				<button class="btn btn-primary btn-small js-articles-move"
					type="button" id="stuList">求职者管理</button>
				<button class="btn btn-primary btn-small js-articles-move"
				type="button">VIP求职者</button>
			</div>
				...
				<tbody class="kaipin-table">
					<c:forEach var="m"  items="${page.elements }" varStatus="index">
						<tr data-tag="${m.userName}">
							...
							<td>${m.oneToOneCount }</td>
							<td>${m.oneToOnePositionCount }</td>
							<td>${m.createTime}</td>
							<td align="center">
							...
							<td align="right">
								...
								| <a href="javascript:void(0)" class="oneToOne" data-name="${m.userName}" data-tag="${m.localUser.id}">一对一服务</a>
							...
							<script type="text/javascript">
	 							...
	 							$(function(){ 
	 								...
	 								$(".oneToOne").click(function(){
	 									...
	 									var entName = $(this).data("name");
	 									var schoolId = $(this).data("orgid");
	 									var openUrl = '${BASE_PATH}/management/stu/main/ontoone?userId=' + id;//弹出窗口的url
	 									var iWidth=800; //弹出窗口的宽度;
	 									var iHeight=600; //弹出窗口的高度;
	 									var iTop = (window.screen.availHeight-30-iHeight)/2; //获得窗口的垂直位置;
	 									var iLeft = (window.screen.availWidth-10-iWidth)/2; //获得窗口的水平位置;
	 									...
	 									//window.open('http://www.baidu.com','','width=600,height=500,left=10, top=10,toolbar=no, status=no, menubar=no, resizable=yes, scrollbars=yes');return false;
	 									setTimeout(function(){
	 										OpenWindow.document.title = "一对一服务：" + entName;
	 									},500);
...
<%-- 		<%@ include file="/WEB-INF/sys/stu/manager/oneToOne.jsp"%> --%>
	...
	<script>
		...
		$(function(){
			...
			$("#stuList").click(function(){
				location.href='${BASE_PATH}/management/stu/main/list';
			});
		});
