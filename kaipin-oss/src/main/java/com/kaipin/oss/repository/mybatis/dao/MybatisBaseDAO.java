...
import com.kaipin.oss.exception.BeanToMapException;
import com.kaipin.oss.util.bean.BeanMapUtil;
...
public abstract class MybatisBaseDAO<T, ID extends Serializable> extends SqlSessionDaoSupport {
	...
	public IGenericPage<T> findPageBy(IBasePageSql sql, Object  param, int pageNo, int pageSize, String sort, String dir) {
...
//			}
		...
		List<T> lst = this.getSqlSession().selectList(getSqlName(pageListSql), param, rowBound);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public IGenericPage<T> findPageBy(Object param, int pageNo, int pageSize, String sort, String dir) {
	 
		PageSqlAdapter sql=new PageSqlAdapter();
	 ...
	 * 
	 */
	public Integer getCountBy(Object param) {
	...
	public Integer getCountBy(String name, Object  param) {
		try {
			if (param == null) {
				param  = new HashMap<String, Object>();
			}
...
//			}
		...
		// paramMap.put("param", param);
		Object o = this.getSqlSession().selectOne(getSqlName(name), param);
		System.out.println(o);
		return (Integer) this.getSqlSession().selectOne(getSqlName(name), param);
	}

	
	public List<T> findListBy(String name, Object param, String sort, String dir) {
	...
	@SuppressWarnings("unchecked")
	public List<T> findListBy(Object param, String sort, String dir) {
		String name = SQL_FINDLISTBY;
		return findListBy(name, param, sort, dir);
	}

	public List<T> findListBy(String name, Object param) {
