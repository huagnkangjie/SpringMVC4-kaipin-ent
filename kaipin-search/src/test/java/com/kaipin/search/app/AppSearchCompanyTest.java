...
public class AppSearchCompanyTest extends JUnitActionBase {
	...
	public void company() {
		...
		try {
			...
			map.put(AppSearchService.KEYWORLD, "重庆尊元文化");
			...
			MvcResult result = mockMvc.perform(post("/search/app/result/company").contentType(MediaType.APPLICATION_JSON_UTF8)
