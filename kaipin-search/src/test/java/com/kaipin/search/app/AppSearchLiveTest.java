...
public class AppSearchLiveTest extends JUnitActionBase {
	...
	public void live() {
		...
		try {
			...
			map.put(AppSearchService.KEYWORLD, "预告");
			...
			MvcResult result = mockMvc.perform(post("/search/app/result/live").contentType(MediaType.APPLICATION_JSON_UTF8)
