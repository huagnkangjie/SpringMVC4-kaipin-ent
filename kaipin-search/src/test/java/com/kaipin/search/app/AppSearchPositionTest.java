...
public class AppSearchPositionTest extends JUnitActionBase {
    ...
    public void login() {
        ...
        try {
            ...
            map.put(AppSearchService.KEYWORLD, "销售人员");
            ...
            MvcResult result = mockMvc.perform(
                    post("/search/app/result/position").contentType(MediaType.APPLICATION_JSON_UTF8)
