...
public class AppSearchSchoolTest extends JUnitActionBase {
    ...
    public void login() {
        ...
        try {
            ...
            map.put(AppSearchService.KEYWORLD, "重庆幼儿师范");
            ...
            MvcResult result = mockMvc.perform(
                    post("/search/app/result/school").contentType(MediaType.APPLICATION_JSON_UTF8)
