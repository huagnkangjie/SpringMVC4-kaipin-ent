...
public class LuceneTaskCompanyActionTest extends JUnitActionBase {
    ...
    public void test(){
        try {
            ...
            map.put(SearchLuceneTasksService.TASK_OBJ_ID, "0de94278-522a-492a-b9c6-ebc9f6c670a8");
            map.put(SearchLuceneTasksService.TASK_OBJ_TYPE, SearchTask.ObjType.company);
