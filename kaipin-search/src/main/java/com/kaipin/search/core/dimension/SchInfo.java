...
public class SchInfo implements Searchable {
	...
	public SchInfo(String id, String title, Map<String, String> extendStoreDatas) {

		this(id, title, extendStoreDatas, null);

	}

	public SchInfo(String id, String title, Map<String, String> extendStoreDatas, Map<String, String> extendIndexDatas) {
		this.id = id;
