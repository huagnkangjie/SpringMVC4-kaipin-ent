...
public class StuUser implements Searchable {
	...
	public StuUser(String id, String title, Map<String, String> extendStoreDatas) {

		this(id, title, extendStoreDatas, null);

	}

	public StuUser(String id, String title, Map<String, String> extendStoreDatas, Map<String, String> extendIndexDatas) {
		this.id = id;
