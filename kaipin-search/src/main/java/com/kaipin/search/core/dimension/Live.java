...
public class Live implements Searchable {
	...
	public Live(String id, String title, Map<String, String> extendStoreDatas) {

		this(id, title, extendStoreDatas, null);

	}

	public Live(String id, String title, Map<String, String> extendStoreDatas, Map<String, String> extendIndexDatas) {
		this.id = id;
