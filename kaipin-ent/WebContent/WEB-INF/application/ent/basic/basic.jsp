...
<link href="${STATIC_SCH }/css/basic.css?v.<%=System.currentTimeMillis()%>" rel="stylesheet" type="text/css" />
	...
	<script type="text/javascript" src="${STATIC_ENT }/js/home/home.js?v.<%=System.currentTimeMillis()%>"></script>
	...
	<script type="text/javascript" >
							...
							<div class="enterBanner" id="enterBannerShow">
                            	...
                            	<!--编辑图片弹框-->
                           		<div class="change-background-img" id="change-background-img" >
                           			...
                           			<a href="javascript:void(0)" id="touch-change-ent" style="width:100%;height:100%;display:block;"></a>
								...
								<div class="modify-lists">
									<form class="" method="post" id="form3" name="form3">
										...
										<div class="modify-cons">
											...
											<textarea class="txt" id="businessDomain" name="businessDomain" value="${infos.businessDomain }"></textarea>
										</div>
										<div class="modify-cons">
										...
										<div class="modify-cons">
												...
												<input type="text" class="md-input mr-15" id="officeAddress" name="officeAddress" maxlength="25" >
								...
								<div class="eiiPanel">
									...
									<div class="fi-otherInfos">
										...
										<div class="oi-field">
											...
											<p class="field-info">
												<c:if test="${infos.businessDomain != null || infos.businessDomain != ''}">
													${infos.businessDomain}
												</c:if>
												<c:if test="${infos.businessDomain == null || infos.businessDomain == ''}">
													如：例：互联网、光能发电、核能研究
												</c:if>
		...
		<script type="text/javascript">
			$(function(){
				...
				var businessDomain = '${infos.businessDomain }';
				$("#businessDomain").val(businessDomain);
