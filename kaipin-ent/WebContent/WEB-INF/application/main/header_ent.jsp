...
<link rel="stylesheet" href="${STATIC_SCH }/css/main.css?v.<%=System.currentTimeMillis()%>" />
<!-- 弹窗 -->
	<link rel="stylesheet" href="${STATIC_SCH }/css/dialog.css?v.<%=System.currentTimeMillis()%>" />
<!-- <link rel="stylesheet" -->
<%-- 	href="${STATIC_SCH }/css/basic.css" /> --%>
	<link rel="stylesheet" href="${STATIC_ENT }/css/basic.css?v.<%=System.currentTimeMillis()%>" />
<script type="text/javascript"
	src="${STATIC_COM }/js/jquery-1.11.1.min.js?v.<%=System.currentTimeMillis()%>"></script>
<script type="text/javascript"
	src="${STATIC_SCH }/js/constants.js?v.<%=System.currentTimeMillis()%>"></script>
<script type="text/javascript"
	src="${STATIC_SCH }/js/common.js?v.<%=System.currentTimeMillis()%>"></script>
<script type="text/javascript"
	src="${STATIC_ENT }/js/common.js?v.<%=System.currentTimeMillis()%>"></script>
<script type="text/javascript"
	src="${STATIC_SCH }/js/header/header.js?v.<%=System.currentTimeMillis()%>"></script>
<script type="text/javascript"
	src="${STATIC_SCH }/js/search/search.js?v.<%=System.currentTimeMillis()%>"></script>
<script type="text/javascript"
	src="${STATIC_ENT }/js/basic.js?v.<%=System.currentTimeMillis()%>"></script>
<script type="text/javascript"
	src="${STATIC_ENT }/js/home/home.js?v.<%=System.currentTimeMillis()%>"></script>
<script type="text/javascript"
	src="${STATIC_ENT }/js/comet/comet4j.js?v.<%=System.currentTimeMillis()%>"></script>
					...
					<div class="message-center fl" id="message-details">
						...
						<div class="message-details">
							...
							<div class="info-lists">
								...
								<dl>
									<dt>
										<a href="${BASE_PATH }/msg/getMsgEntViewList" id="entViewList"
							...
							<div class="info-lists">
								<ul>
									<li><span class="setting-icon set"></span> <a
										href="javascript:void(0)" id="ent-account-set-btn">设置</a></li>
		...
		<div class="personal-set" id="personal-set-panel">
			...
			<div class="ps-info-cos">
				<div class="header-info">
					<a href="javascript:void(0)" title="" class="hd-logo" id="person-hd-logo"><img  src="${STATIC_SCH }/images/moren.jpg" width="48" height="48"></a>
				...
				<div class="personal-forms">
					<form method="post">
						<div class="pf-totalStyle">
							...
							<a href="javascript:void(0)" class="update-pswd" id="bind-phone">更新</a>
						</div>
						...
						<div class="pf-otherStyle">
							...
							<div class="pf-totalStyle">
								...
								<input type="text" id="user-userName" name="missSurname" class="pf-input"/>
							</div>
							<div class="clear"></div>
						</div>
...
<!-- 						</div> -->
						...
						<div class="submit-box">
							<a href="javascript:void(0)" id="ent-save-user-info">完成</a>
						</div>
					</form>
				</div>
			</div>
					...
					<div class="bd-input">
						...
						<div class="input-cons fz fr">
							...
							<a href="javascript:void(0)" class="btn sure-btn" style="display:none;" id="config-mail-btn-ing">
								提交中...<img src="${STATIC_SCH }/images/loading.gif" width="16" height="16" style="margin-left:5px"/>
							</a>
