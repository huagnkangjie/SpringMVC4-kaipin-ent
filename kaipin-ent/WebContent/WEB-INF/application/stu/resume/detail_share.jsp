...
<!-- header-start -->
<%@ include file="/WEB-INF/application/main/header_login.jsp"%>
<!-- header-end -->
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			if(flag){
				...
				$("#attentionBtn").attr("href","javascript:void(0);");
				bindAddFollow();
			}else{
...
<!-- 						<img src="http://kaipin.com:8083:82/12/2016/images/info/0/a2fdef36-db4e-4c25-aa89-b482b2217f06.jpg"> -->
					...
					<div class="per-infoLists">
								...
								<div class="info-per-lists">
									<p class="signature"><span>个性签名：</span> 
...
<!-- 								<p class="post"><span>技术经理</span>某某某某公司<span class="data">2004年9月-2008年</span></p> -->
<!-- 								<p class="post"><span>技术经理</span>某某某某公司<span class="data">2004年9月-2008年</span></p> -->
							</div>
							<!--职业背景 end-->
