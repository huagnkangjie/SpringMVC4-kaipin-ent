...
public class VideoThumb
{
    ...
    public VideoThumb(String ffmpegApp)
    {
    ...
    { 
        VideoThumb videoThumbTaker = new VideoThumb("D:\\c\\1\\ffmpeg.exe");
        try
        {
            videoThumbTaker.getThumb("D:\\c\\1\\mp42.mp4", "D:\\c\\1\\thumbTest.png",    800, 600, 0, 0, 9);
