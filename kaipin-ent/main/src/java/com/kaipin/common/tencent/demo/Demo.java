package com.kaipin.common.tencent.demo;
...
import com.kaipin.common.tencent.json.JSONObject;
import com.kaipin.common.tencent.xinge.ClickAction;
import com.kaipin.common.tencent.xinge.Message;
import com.kaipin.common.tencent.xinge.MessageIOS;
import com.kaipin.common.tencent.xinge.Style;
import com.kaipin.common.tencent.xinge.TagTokenPair;
import com.kaipin.common.tencent.xinge.TimeInterval;
import com.kaipin.common.tencent.xinge.XingeApp;
...
public class Demo {
	...
	public static void test(){
		for (int i = 0; i < 100; i++) {
			System.out.println(XingeApp.pushAllIos(2200166753L, 
					"caef7daddb58cc91555ff5b7f6c697e2", 
					"测试" + i, 
					XingeApp.IOSENV_DEV));
			System.out.println(XingeApp.pushAllAndroid(
					2100166752, 
					"7b385f7f61969ab405eede20e1bb26fd", 
					"222222", 
					"测试  " + i)
					);
		}
...
//		System.out.println(XingeApp.pushTokenAndroid(2100166755, "132afcc623424c19c61a9d219951f425", "test3", "测试", "token"));
//		System.out.println(XingeApp.pushAccountAndroid(2100166752, "7b385f7f61969ab405eede20e1bb26fd", "title", "conent", "stud12e808af601432eb7685c154ce7b5e5"));
//		System.out.println(XingeApp.pushAllAndroid(2100166752, "7b385f7f61969ab405eede20e1bb26fd", "222222", "测试"));
...
//		System.out.println(XingeApp.pushAccountIos(2200166753L, "caef7daddb58cc91555ff5b7f6c697e2", "conent", "stub9319fa428714f3095921d8b95ba853c", XingeApp.IOSENV_DEV));
//		System.out.println(XingeApp.pushAllIos(2200166753L, "caef7daddb58cc91555ff5b7f6c697e2", "测试", XingeApp.IOSENV_DEV));
...
//		System.out.println(t.demoPushSingleAccount());
	...
	protected JSONObject demoPushSingleAccount() {
		XingeApp xinge = new XingeApp(2100166752, "7b385f7f61969ab405eede20e1bb26fd");
		Message message = new Message();
		message.setExpireTime(86400);
		message.setTitle("title");
		message.setContent("content");
